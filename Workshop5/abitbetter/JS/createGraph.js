function createGraph() {
	...
	d3.csv("../data/back-mapping-file.csv", function(d) {
		...
		data.forEach(function(d) {
			a = +d.antibody;
			year1 = d.taken_year;
			month1 = d.taken_month;
			// create date 1 as an object (see above: var parseTime = d3.timeParse("%m/%Y");)
			date1 = parseTime(month1+"/"+year1);
			year2 = d.infected_year;
			month2 = d.infected_month;
			// create date 2 as an object (see above: var parseTime = d3.timeParse("%m/%Y");)
			date2 = parseTime(month2+"/"+year2);
